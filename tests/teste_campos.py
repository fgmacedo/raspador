...
class TesteDeBaseField(unittest.TestCase):
    ...
    def teste_deve_recusar_callback_invalido(self):
        self.assertRaises(
            TypeError,
            lambda: BaseField(r'COO:(\d+)', ao_atribuir='pegadinha')
        )
...
class TesteDeIntegerField(unittest.TestCase):
...
class TesteDeFloatField(unittest.TestCase):
    def teste_deve_obter_valor(self):
...
class TesteDeStringField(unittest.TestCase):
    def teste_deve_obter_valor(self):
        s = "1   Dinheiro                                       0,00"
...
class TesteDeBooleanField(unittest.TestCase):
    s = "                      CANCELAMENTO                      "
...
class TesteDeDateField(unittest.TestCase):
    def teste_deve_obter_valor(self):
        s = "02/01/2013 10:21:51           COO:022734"
...
class TesteDeDateTimeField(unittest.TestCase):
    def teste_deve_obter_valor(self):
        s = "02/01/2013 10:21:51           COO:022734"
